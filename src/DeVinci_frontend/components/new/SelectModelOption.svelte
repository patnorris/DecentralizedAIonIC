...
<li>
  <input type="radio" id={id} name={name} value={value} class="hidden peer" on:click={() => callbackLoadChatModel(id)} />
  <label for={id} class="inline-flex items-center justify-between w-full p-3 text-[#151b1e] bg-[#e5ddd4] border-2 border-[#151b1e] rounded-lg cursor-pointer peer-checked:bg-gray-100 peer-checked:border-[#151b1e] peer-checked:text-[#151b1e] hover:text-gray-600 hover:bg-gray-100">
    <div class="block">
